...
using SWTarefas.Application.UsesCases.TarefasUseCases.UseCases.Read.Dapper.Filter;
using SWTarefas.Application.UsesCases.TarefasUseCases.UseCases.Read.Dapper.GetAll;
using SWTarefas.Application.UsesCases.TarefasUseCases.UseCases.Read.Dapper.GetById;
using SWTarefas.Application.UsesCases.TarefasUseCases.UseCases.Read.EF.Filter;
using SWTarefas.Application.UsesCases.TarefasUseCases.UseCases.Read.EF.GetAll;
using SWTarefas.Application.UsesCases.TarefasUseCases.UseCases.Read.EF.GetById;
using SWTarefas.Application.UsesCases.TarefasUseCases.UseCases.Write.Dapper.Create;
using SWTarefas.Application.UsesCases.TarefasUseCases.UseCases.Write.Dapper.Update;
using SWTarefas.Application.UsesCases.TarefasUseCases.UseCases.Write.EF.Create;
