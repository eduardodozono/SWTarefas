...
namespace SWTarefas.Infrastructure.DataAcess.EF.Repository.Tarefas
{
    public class TarefaRepository : ITarefaDeleteRepository, ITarefaReadRepository, ITarefaWriteRepository
    {
        ...
        protected Task<T> Execute<T>(Func<SWTarefasContext, Task<T>> funcao)
        {
            return funcao(_sWTarefasContext);
        }
    }
}
